 ...
 */
export function generatePickingSystemTemplate(options) {
...
export function generatePrefabSpawnerTemplate(options) {
...
export function generateObjectPoolTemplate(options) {
...
export function generateTagFilterTemplate(options) {
    const { name } = options;
    return `import * as RE from 'rogue-engine';
import * as THREE from 'three';
...
//# sourceMappingURL=gameplay-templates.js.map